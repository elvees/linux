...
/* Subsystems that can be accessed from Linux */
#define MCOM03_SUBSYSTEM_CPU		0
#define MCOM03_SUBSYSTEM_SDR		1
#define MCOM03_SUBSYSTEM_MEDIA		2
#define MCOM03_SUBSYSTEM_HSPERIPH	3
#define MCOM03_SUBSYSTEM_LSPERIPH0	4
#define MCOM03_SUBSYSTEM_LSPERIPH1	5
#define MCOM03_SUBSYSTEM_DDR		6
#define MCOM03_SUBSYSTEM_SERVICE	7
#define MCOM03_SUBSYSTEM_MAX		8
