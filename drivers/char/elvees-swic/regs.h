...
#define SWIC_STATUS_S_LVDS_RX			BIT(30)
#define SWIC_STATUS_D_LVDS_RX			BIT(31)
...
#define SWIC_MODE_CR_LVDS_MODE			BIT(29)
#define SWIC_MODE_CR_S_LVDS_TX			BIT(30)
#define SWIC_MODE_CR_D_LVDS_TX			BIT(31)
